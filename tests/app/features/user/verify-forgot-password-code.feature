Feature: Verify Forgot Password Code
    ...
    Scenario: A valid forgot password code
        Given I send a POST request to "/api/user/auth/password/verify-code" with body:
            """
            {
                "code": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJyZXN0b3JlX3Bhc3N3b3JkIjp0cnVlLCJ1c2VyIjoiYmZkZGM2ZjYtNDQ1ZC00Y2FiLWE3YTQtNDM1Yjk3MDlhZjRhIiwiaWF0IjoxNjY2NzI4MzcyfQ.wt8PjFpR7ZX5-eLjqCBU5XWKWhn0o1p9XEUZJyocveM"
            }
            """
